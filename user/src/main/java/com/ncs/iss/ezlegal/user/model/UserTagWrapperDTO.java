...
public class UserTagWrapperDTO implements Serializable {
	...
	public UserTagWrapperDTO() {
		super();
	}

	public UserTagWrapperDTO(String forumTagId, String forumId, String tagId, String tagName, String tagDescription) {
		super();
